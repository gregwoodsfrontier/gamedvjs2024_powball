...
export const GameOptions = {
    ...
    ballbodies: [
        ...
        {score: 70, size: 30, audioKey:'punch_med_0', spriteKey:'bowling' , particleSize: 50, color: 0x0078ff},
        {score: 90, size: 35, audioKey:'punch_med_4', spriteKey:'football' , particleSize: 60, color: 0x0078ff},
        {score: 100, size: 40, audioKey:'punch_med_4', spriteKey:'basketball' , particleSize: 70, color: 0x0078ff},
    ],
